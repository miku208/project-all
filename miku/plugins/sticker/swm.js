...
import { addExifToWebp, isAnimatedWebp, DEFAULT_METADATA } from '../../src/lib/miku-exif.js'
...
async function handler(m, { sock, config: botConfig }) {
    ...
    if (!quoted) {
        return m.reply(
            ...
            `*ᴄᴏɴᴛᴏʜ:*\n` +
            `> \`${m.prefix}swm Miku-AI\`\n` +
            `> \`${m.prefix}swm Miku-AI|LuckyArchz\` _(packname + author)_`
        )
    }
    ...
    if (!input) {
        return m.reply(
            ...
            `*ᴄᴏɴᴛᴏʜ:*\n` +
            `> \`${m.prefix}swm Miku-AI\`\n` +
            `> \`${m.prefix}swm Miku-AI|LuckyArchz\` _(+ author)_`
        )
    }
