import {
  ...
  isLidConverted,
  lidToJid,
} from "../../src/lib/miku-lid.js";
import moment from "moment-timezone";
import config from "../../config.js";
import { getDatabase } from "../../src/lib/miku-database.js";
import { saluranCtx } from "../../src/lib/miku-context.js";
import { createGoodbyeCard } from "../../src/lib/miku-welcome-card.js";
import { resolveAnyLidToJid } from "../../src/lib/miku-lid.js";
...
function resolvePlaceholders(
  ...
  return template
    ...
    .replace(/{bot}/gi, config.bot?.name || "Miku")
...
async function sendGoodbyeMessage(sock, groupJid, participant, groupMeta) {
  try {
    ...
    if (goodbyeType === 2) {
      ...
      await sock.sendMessage(groupJid, {
        video: getAssetBuffer("miku-mp4") || { url: "https://files.catbox.moe/k28dhp.mp4" },
        gifPlayback: true,
        caption: text,
        contextInfo: {
          mentionedJid: [realParticipant],
