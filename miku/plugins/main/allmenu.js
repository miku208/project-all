...
import { generateWAMessageFromContent, prepareWAMessageMedia, proto } from "mikuhostt-baileys";
...
import { getCasesByCategory, getCaseCount } from "../../case/miku.js";
const pluginConfig = {
  name: "allmenu",
  ...
  try {
    switch (allmenuVariant) {
      ...
      case 5: {
        ...
        const thumbnail = await _sharp(fs.readFileSync(config.assets["miku"])).resize(300, 300).toBuffer()
        const qOrder = {
