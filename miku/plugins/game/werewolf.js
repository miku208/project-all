...
try {
  ...
  if (fs.existsSync(path.join(assetsPath, "miku-games.jpg"))) {
    thumbWW = fs.readFileSync(path.join(assetsPath, "miku-games.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "miku.jpg"))) {
    thumbNight = fs.readFileSync(path.join(assetsPath, "miku.jpg"));
    thumbDay = fs.readFileSync(path.join(assetsPath, "miku.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "miku-winner.jpg"))) {
    thumbWin = fs.readFileSync(path.join(assetsPath, "miku-winner.jpg"));
  }
} catch (e) {
