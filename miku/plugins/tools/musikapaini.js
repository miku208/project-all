...
import { downloadMediaMessage } from "mikuhostt-baileys";
import te from "../../src/lib/miku-error.js";
import mikuApi from "../../src/lib/miku-apimanager.js";
...
async function handler(m, { sock }) {
  ...
  try {
    ...
    const data = await mikuApi.neoxr.whatMusic(
      {
        url: audioUrl,
        apikey: config.APIkey?.neoxr || "Milik-Bot-MikuMD",
      },
      {
        timeout: 60000,
      },
