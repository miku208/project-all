...
/**
 * @typedef {Object} MikuApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} MikuApiProviderShape
 * @property {string} baseURL
 * @property {MikuApiAuthShape} [auth]
...
/**
 * @typedef {Object} MikuApiRequestOptions
...
/**
 * @typedef {Object} MikuApiMultipartFile
 ...
 */
class MikuApiProvider {
  /**
   * @param {MikuApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {MikuApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {MikuApiMultipartFile[]|Object<string, any>} [files]
   * @param {MikuApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends MikuApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends MikuApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends MikuApiProvider {
...
class ApiFaaProvider extends MikuApiProvider {
...
class MikuMainApiProvider extends MikuApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends MikuApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends MikuApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends MikuApiProvider {
...
class AzbryApiProvider extends MikuApiProvider {
...
class YuulabsApiProvider extends MikuApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends MikuApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends MikuApiProvider {
...
/**
 * API manager terpusat untuk provider eksternal Miku.
 */
class MikuApiManager {
  /**
  ...
  /**
   * @param {string} name
   * @param {MikuApiProviderShape} cfg
   * @returns {MikuApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<MikuApiProviderShape>} cfg
   * @returns {MikuApiProvider}
   */
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || MikuApiProvider;
...
const mikuApi = new MikuApiManager();

export { MikuApiManager, MikuApiProvider, mikuApi };
export default mikuApi;
