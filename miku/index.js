...
import { loadPlugins, pluginStore } from "./src/lib/miku-plugins.js";
import { initDatabase, getDatabase } from "./src/lib/miku-database.js";
import {
  initScheduler,
  loadScheduledMessages,
  startGroupScheduleChecker,
  startSewaChecker,
} from "./src/lib/miku-scheduler.js";
import { handleAntiTagSW } from "./src/lib/miku-group-protection.js";
import { initSholatScheduler } from "./src/lib/miku-sholat-scheduler.js";
import { initNotifScheduler } from "./src/lib/miku-notif-scheduler.js";
import { initAutoJpmScheduler } from "./src/lib/miku-auto-jpm.js";
import { startMemoryMonitor } from "./src/lib/miku-memory-monitor.js";
import { startTempCleaner } from "./src/lib/miku-temp-cleaner.js";
import { startDailyPruner } from "./src/lib/miku-data-pruner.js";
import { preloadAssets } from "./src/lib/miku-asset-manager.js";
import { startCacheServer } from "./src/server/cacheServer.js";
startCacheServer(3001);
import {
  logger,
  c,
  playBootSequence,
  ...
  logErrorBox,
  divider,
} from "./src/lib/miku-logger.js";

await import("./src/lib/miku-agent.js")
...
/**
 * Hot-reload watcher untuk plugins.
 * Aktif di mode development (config.dev.enabled) maupun production
 * (config.plugins.hotReload = true) supaya edit plugin tidak perlu restart.
 */
    ...
    (eventType, filename) => {
      ...
      const timeout = setTimeout(async () => {
        ...
        if (!fs.existsSync(fullPath)) {
          ...
          const { unloadPlugin } = await import("./src/lib/miku-plugins.js");
        ...
        try {
          ...
          const { hotReloadPlugin } =
            await import("./src/lib/miku-plugins.js");
...
async function main() {
  ...
  if (
    (config.dev?.enabled && config.dev?.watchPlugins) ||
      ...
      if (update.connection === "open") {
        ...
        try {
          const { startOtpPoller: _startOtp } =
            await import("./src/lib/miku-otp-poller.js");
          _startOtp(sock);
        } catch { }
