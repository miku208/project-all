...
function isJadibotSelf(jadibotId) {
    const db = loadJadibotDb(jadibotId)
    return db.settings.self === true
}

function setJadibotSelf(jadibotId, value) {
    const db = loadJadibotDb(jadibotId)
    db.settings.self = !!value
    saveJadibotDb(jadibotId)
    return db.settings.self
}
...
export { loadJadibotDb, saveJadibotDb, isJadibotOwner, addJadibotOwner, removeJadibotOwner, getJadibotOwners, isJadibotPremium, addJadibotPremium, removeJadibotPremium, getJadibotPremiums, isJadibotSelf, setJadibotSelf, getJadibotSetting, setJadibotSetting, getJadibotUser, setJadibotUser, getJadibotGroup, setJadibotGroup, getAllJadibotData }