...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
  ...
  communityCreate: (
    subject: string,
    body: string,
  ) => Promise<import("../index.js").GroupMetadata | null>;
  ...
  getCatalog: ({
    ...
    limit,
    cursor,
  }: import("../index.js").GetCatalogOptions) => Promise<{
  ...
  productCreate: (
    create: import("../index.js").ProductCreate,
  ...
  productUpdate: (
    productId: string,
    update: import("../index.js").ProductUpdate,
  ) => Promise<import("../index.js").Product>;
  ...
  updateCoverPhoto: (
    photo: import("../index.js").WAMediaUpload,
  ) => Promise<number>;
  removeCoverPhoto: (id: string) => Promise<any>;
  sendMessageAck: (
    node: import("../index.js").BinaryNode,
    errorCode?: number,
  ) => Promise<void>;
  sendRetryRequest: (
    node: import("../index.js").BinaryNode,
  ...
  createParticipantNodes: (
    ...
    message: import("../index.js").proto.IMessage,
    extraAttrs?: import("../index.js").BinaryNode["attrs"],
  ...
  newsletterUpdatePicture: (
    jid: string,
    content: import("../index.js").WAMediaUpload,
  ) => Promise<unknown>;
