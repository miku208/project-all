/**
 * Miku-Baileys Advanced WhatsApp Interactive Message Builder
 * Creating buttons, carousels, native flows, and AI rich response
 * payloads using Baileys with fluent chaining, flexible payload
 * customization, and scalable architecture for modern bot development.
 *
 * Part of the Miku-Baileys distribution.
...
try {
    ...
    console.warn('⚠️ [miku-baileys] WARNING: Module "sharp" is not installed. Image resizing & processing may not work.\n👉 Please run: npm install sharp');
}

try {
    ffmpeg = (await import('fluent-ffmpeg')).default;
} catch {
    console.warn('⚠️ [miku-baileys] WARNING: Module "fluent-ffmpeg" is not installed. Video previews may not work.\n👉 Please run: npm install fluent-ffmpeg');
}
